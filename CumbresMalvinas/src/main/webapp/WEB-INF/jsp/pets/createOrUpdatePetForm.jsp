    ...
    <jsp:body>
        ...
        <form:form modelAttribute="pet"
            ...
            <div class="form-group has-feedback">
                ...
                <CumbresMalvinas:inputField label="Name" name="name"/>
                <CumbresMalvinas:inputField label="Birth Date" name="birthDate"/>
                <div class="control-group">
                    <CumbresMalvinas:selectField name="type" label="Type " names="${types}" size="5"/>
                </div>
            </div>
            <div class="form-group">
